...
MODEL_PATH=model/vit-s-k400.pt     # PATH of your Pretrained MODEL
YOURPATH=xxx/xxx/xxx  # PATH of your CKPT, e.g., Mine: checkpoints/hmdb51/VideoMAES_meta_deepbdc_5way_5shot_2TAA
cd ../../../
